...
const SLIDE = [
    ...
    { alt:"Six slide",pictitle:'Bebbanburgers',src:`${FithImage}`,Description:"an app for a fictional restaurant based on the Netflix show, The Last Kingdom. Created with MySQL, Node, Express, Handlebars and a homemade ORM.", github: "https://github.com/rjkenney11/Nice-Buns", state:"carousel-item"},
