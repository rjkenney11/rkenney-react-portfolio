...
const SLIDE = [
    { alt:"Third slide",title:'Adventure Companion',href:"https://bartok1945.github.io/adventure_companion/",src:`${FirstImage}`,Description:"A dynamic digital character sheet for Dungeons & Dragons", github: "https://github.com/Bartok1945/adventure_companion", state:" carousel-item active"},
    { alt:"First slide",titlee:'D-Pad',src:`${EighthImage}`,Description:"D-Pad is an app allows users to browse video games and organize their favorites with ease.", github: "https://github.com/Bartok1945/d_pad", state:"carousel-item"},
    { alt:"Second slide",titlee:'D-Pad',src:`${NinthImage}`,Description:"D-Pad is an app allows users to browse video games and organize their favorites with ease.", github: "https://github.com/Bartok1945/d_pad", state:"carousel-item"},
    ...
    { alt:"Fith slide",titlee:'Bebbanburgers',src:`${FithImage}`,Description:"an app for a fictional restaurant based on the Netflix show, The Last Kingdom.", github: "https://github.com/rjkenney11/Nice-Buns", state:"carousel-item"},
    { alt:"Six slide",titlee:'Pallet Town Pokedex',src:`${SecondImage}`,Description:"Demonstrated the base utilization of CRUD by creating an app to organize and keep track of your Pokemon Cards.", github: "https://github.com/asheth22/Project2-Pokemon", state:"carousel-item"},
    { alt:"Seven slide",titlee:'Pallet Town Pokedex (Part 2)',src:`${ThirdImage}`,Description:"Demonstrated the base utilization of CRUD by creating an app to organize and keep track of your Pokemon Cards.", github: "https://github.com/asheth22/Project2-Pokemon", state:"carousel-item"},
