...
const SLIDE = [
    ...
    { alt:"Second slide",title:'D-Pad',src:`${TenthImage}`,Description:"D-Pad is an app that allows users to browse video games and organize their favorites with ease. Built using React, JavaScript & CSS.", github: "https://github.com/Bartok1945/d_pad", state:"carousel-item"},
    ...
    { alt:"Fith slide",title:'Bebbanburgers',src:`${FithImage}`,Description:"an app for a fictional restaurant based on the Netflix show, The Last Kingdom.", github: "https://github.com/rjkenney11/Nice-Buns", state:"carousel-item"},
    { alt:"Six slide",title:'Pallet Town Pokedex',src:`${SecondImage}`,Description:"Demonstrated the base utilization of CRUD by creating an app to organize and keep track of your Pokemon Cards.", github: "https://github.com/asheth22/Project2-Pokemon", state:"carousel-item"},
    { alt:"Seven slide",title:'Pallet Town Pokedex (Part 2)',src:`${ThirdImage}`,Description:"Demonstrated the base utilization of CRUD by creating an app to organize and keep track of your Pokemon Cards.", github: "https://github.com/asheth22/Project2-Pokemon", state:"carousel-item"},
