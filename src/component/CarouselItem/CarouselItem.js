...
const SLIDE = [
    ...
    { alt:"Six slide",pictitle:'Bebbanburgers',src:`${FithImage}`,Description:"fictional restaurant app created with MySQL, Node, Express, Handlebars and a homemade ORM.", github: "https://github.com/rjkenney11/Nice-Buns", state:"carousel-item"},
