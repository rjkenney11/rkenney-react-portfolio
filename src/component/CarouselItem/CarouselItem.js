...
const SLIDE = [
    { alt:"First slide",pictitle:'D-Pad',src:`${EighthImage}`,Description:"D-Pad is an app that allows users to browse video games and organize their favorites with ease. Built using React, JavaScript & CSS.", github: "https://github.com/Bartok1945/d_pad", state:"carousel-item active"},
    { alt:"Second slide",pictitle:'D-Pad',src:`${NinthImage}`,Description:"D-Pad is an app that allows users to browse video games and organize their favorites with ease. Built using React, JavaScript & CSS.", github: "https://github.com/Bartok1945/d_pad", state:"carousel-item"},
    { alt:"Third slide",pictitle:'D-Pad',src:`${TenthImage}`,Description:"D-Pad is an app that allows users to browse video games and organize their favorites with ease. Built using React, JavaScript & CSS.", github: "https://github.com/Bartok1945/d_pad", state:"carousel-item"},
    ...
    { alt:"Six slide",pictitle:'Bebbanburgers',src:`${FithImage}`,Description:"an app for a fictional restaurant based on the Netflix show, The Last Kingdom.", github: "https://github.com/rjkenney11/Nice-Buns", state:"carousel-item"},
