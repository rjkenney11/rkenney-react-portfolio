...
function AboutMe() {
  return (
        <div className="jumbotron">
            <img className="card-img-top" src="https://user-images.githubusercontent.com/74163812/117556525-e402a300-b037-11eb-9a20-e169f72d4d6d.png" alt="Rachel-Banner"></img>
             <hr></hr>
            <hr></hr>
