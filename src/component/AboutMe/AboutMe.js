  ...
  return (
        <div className="jumbotron">
            ...
            <div className="container-text">
                ...
                <p>I was recently given the opportunity to pursue a UX/UI Design certification through John's Hopkins University and successfully completed the course with an "A" in May of 2021. I am eagerly looking forward to pursuing a career as a Full-Stack Web Developer as it scratches my creative itch, keeps my mind engaged and encourages me to be a lifelong learner.</p>
